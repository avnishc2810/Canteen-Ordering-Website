# Generated by Django 5.1.6 on 2025-03-04 20:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='product',
            name='category',
            field=models.CharField(blank=True, choices=[('Eatables', 'EATABLES'), ('Drinks', 'DRINKS'), ('Thali', 'THALI')], max_length=15, null=True),
        ),
